# Generated by Django 4.0.6 on 2022-07-24 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competitorA', models.ManyToManyField(related_name='competitorA', to=settings.AUTH_USER_MODEL)),
                ('competitorB', models.ManyToManyField(related_name='CompetitorB', to=settings.AUTH_USER_MODEL)),
